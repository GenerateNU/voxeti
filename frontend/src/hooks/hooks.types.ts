...
export interface UseGoogleProps {
  googleSSO : MutationTrigger<MutationDefinition<string, BaseQueryFn<string | FetchArgs, unknown, FetchBaseQueryError, object, FetchBaseQueryMeta>, never, UserSliceState, "authApi">>;
  setProviderLoginPending : React.Dispatch<React.SetStateAction<boolean>>;
  setProviderUser : React.Dispatch<React.SetStateAction<UserSliceState | undefined>>;
}
